...
env_module.HIST_LEN = args.hist_len # i think just... makes a new variable and doesn't throw error even if guy doesn't exist...
	...
	with torch.no_grad():
		for i in range(num_iterations):
			...
			for stat_name, stat_fn in problem_specific_stats.items():
				stat_val = stat_fn(obs, start_state, done_state)
